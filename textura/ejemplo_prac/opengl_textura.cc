...
GLfloat verticesSuelo[] = { -4.0, 0.0, 4.0,    4.0, 0.0, 4.0,     4.0, 0.0, -4.0,    -4.0, 0.0, -4.0 };
GLfloat texVerticesSuelo[] = { 0.0, 1.0,    0.5, 1.0,    0.5, 0.5,    0.0, 0.5};
...
void Init(int argc, char **argv){
   ...
   prepara_textura("./puente_rio.jpg", &textura_id_suelo);
}
...
//
   glBindTexture(GL_TEXTURE_2D, textura_id_suelo);

   glVertexPointer(3, GL_FLOAT, 0, verticesSuelo);
   glTexCoordPointer(2, GL_FLOAT, 0, texVerticesSuelo);
